...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cortex Web Labs — Intelligent Systems for Business Scale" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Orbitron:wght@500;600;700;800;900&family=Rajdhani:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster
        ...
        toastOptions={{
          style: {
            background: "linear-gradient(180deg, oklch(0.22 0.03 260 / 0.95), oklch(0.16 0.02 260 / 0.95))",
            border: "1px solid oklch(0.78 0.19 232 / 0.5)",
            color: "oklch(0.97 0.01 240)",
            boxShadow: "0 0 24px oklch(0.78 0.19 232 / 0.35)",
